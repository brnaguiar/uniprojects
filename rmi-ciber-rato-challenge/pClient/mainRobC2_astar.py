        ...
        if (cardinal == "N" or cardinal == "S"):
            ...
            if abs((self.measures.x - self.next_cell[0]) == 0) or self.measures.irSensor[0] > 2: #:
                ...
                if abs(self.measures.x - self.next_cell[0]) > 0.2:
                    p = self.pcontrol(self.next_cell[1], self.measures.y, kp_far) if cardinal == "N" else  self.pcontrol(self.measures.y, self.next_cell[1], kp_far)
                    #self.driveMotors(0.14, 0.14 )
                    self.driveMotors(0.14 - (p/2), 0.14 + (p/2))
                    return "walk"
                else:
                    p = self.pcontrol(self.next_cell[1], self.measures.y, kp_close) if cardinal == "N" else  self.pcontrol(self.measures.y, self.next_cell[1], kp_close)
            ...
            if abs(self.measures.y - self.next_cell[1]) == 0 or self.measures.irSensor[0]> 2:      #and self.measures.irSensor[0] < 2:
                ...
                if abs(self.measures.y - self.next_cell[1]) > 0.2:
                    p = self.pcontrol(self.measures.x, self.next_cell[0], kp_far) if cardinal == "O" else  self.pcontrol(self.next_cell[0], self.measures.x, kp_far)
                    #self.driveMotors(0.14, 0.14 )
                    self.driveMotors(0.14 - (p/2), 0.14 + (p/2))
                    return "walk"
                else:
                    p = self.pcontrol(self.measures.x, self.next_cell[0], kp_close) if cardinal == "O" else  self.pcontrol(self.next_cell[0], self.measures.x, kp_close) 
                    #self.driveMotors(0.014, 0.014 )
                    self.driveMotors(0.014 - (p/2), 0.014 + (p/2))
                    return "walk"
