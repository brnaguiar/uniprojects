    ...
    def wander(self):
        ...
        if self.measures.irSensor[center_id] > 1:
            if self.measures.irSensor[left_id] > self.measures.irSensor[right_id]:
                if self.measures.irSensor[left_id] > 4:
                ...
                if self.measures.irSensor[right_id] > 4:
                    ...
                    self.driveMotors(-0.1,+0.1)
        elif self.measures.irSensor[center_id] < 1 and self.measures.irSensor[left_id] > 3:
            self.driveMotors(+0.05,-0.1)
        elif self.measures.irSensor[center_id] < 1 and self.measures.irSensor[right_id] > 3:
            self.driveMotors(-0.05,+0.1)
        else:
