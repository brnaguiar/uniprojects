...
HD_PWD='C:/Users/brunoa/Documents/cr/proj2/lfsr_tb/lfsr_tb/lfsr_tb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lfsr_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lfsr_tb.tcl
