...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../lfsr_mb.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../lfsr_mb.gen/sources_1/bd/design_1/ipshared/d0f7" \
       +incdir+"../../../../lfsr_mb.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../lfsr_mb.gen/sources_1/bd/design_1/ipshared/d0f7"
}
